...
```tsx
import { CopilotKitCSSProperties } from "@turbo-agent/copilotkit-react-ui";
...
<Callout>
For a full list of styles and classes used in CopilotKit, click [here](https://github.com/Sherler/CopilotKit/blob/main/CopilotKit/packages/react-ui/src/css/).
</Callout>

...
<Callout>
  ...
  project](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-crewai-flows).
</Callout>
...
<Steps>
  <Step>
    ...
    This guide uses the [CoAgents starter repo](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-crewai-flows) as its starting point.

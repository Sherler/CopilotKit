...
<Callout>
  ...
  project](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-llamaindex).
</Callout>
...
If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/llamaindex/starter) as a starting point

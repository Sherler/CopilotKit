...
<Callout type="info">
  ...
  starter](https://github.com/Sherler/CopilotKit/tree/main/examples/llamaindex/starter)
...
<Steps>
    <Step>
        ...
        If you don't already have an agent, you can use the [llamaindex starter](https://github.com/Sherler/CopilotKit/tree/main/examples/llamaindex/starter) as a starting point

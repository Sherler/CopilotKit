...
<TailoredContent id="experience" defaultOptionIndex={0}>
    ...
    >
        ...
        ### Examples
        An excellent example of the type of experiences you can accomplish with CoAgents applications can be found in our [Research Canvas](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-research-canvas).

...
<Callout>
  ...
  starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-crewai-crews)
...
<Steps>
  <Step>
    ...
    If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagent-starter-crewai-crews) as a starting point

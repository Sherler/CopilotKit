...
<Callout>
    Have an issue not listed here? Open a ticket on [GitHub](https://github.com/Sherler/CopilotKit/issues) or reach out on [Discord](https://discord.com/invite/6dffbvGU3D)
    and we'll be happy to help.

    We also highly encourage any open source contributors that want to add their own troubleshooting issues to [Github as a pull request](https://github.com/Sherler/CopilotKit/blob/main/CONTRIBUTING.md).

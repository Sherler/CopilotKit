...
See the [sample agent implementation](https://github.com/Sherler/CopilotKit/blob/main/examples/coagents-starter---YOUR-FRAMEWORK--/agent-py/sample_agent/agent.py#L291)

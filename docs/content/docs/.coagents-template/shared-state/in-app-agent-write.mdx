...
<Callout>
  ...
  starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter---YOUR-FRAMEWORK--)
...
<Steps>
  <Step>
    ...
    If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagent-starter) as a starting point

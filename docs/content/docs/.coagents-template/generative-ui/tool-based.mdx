...
<Callout>
  ...
  project](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter---YOUR-FRAMEWORK--).
</Callout>
...
If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter---YOUR-FRAMEWORK--) as a starting point
...
import { useCopilotAction } from "@turbo-agent/copilotkit-react-core"; // [!code highlight]
// ...

...
<Steps>
  <Step>
    ...
    This guide uses the [CoAgents starter repo](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter---YOUR-FRAMEWORK--) as its starting point.

...
<Steps>
    <Step>
        ...
        If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/mastra/starter) as a starting point

    ...
    >
        ...
        >
            ...
            <Step>
                ...
                ```package-install
                @think-copilotkit/react-ui @think-copilotkit/react-core @think-copilotkit/runtime @ag-ui/mastra @mastra/client-js
                ```
            </Step>
            <Step>
            ...
            <Step>
              ...
              import { CopilotSidebar } from "@think-copilotkit/react-ui"; // [!code highlight]

    ...
    >
        ...
        >
            ...
            <Step>
                ...
                ```package-install
                @turbo-agent/copilotkit-react-ui @turbo-agent/copilotkit-react-core @turbo-agent/copilotkit-runtime @ag-ui/mastra @mastra/client-js
                ```
            </Step>
            <Step>
            ...
            <Step>
              ...
              import { CopilotSidebar } from "@turbo-agent/copilotkit-react-ui"; // [!code highlight]

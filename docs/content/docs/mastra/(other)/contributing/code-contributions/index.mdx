...
<Steps>
  <Step>
  ### Fork The Repository
  First, head over to the [CopilotKit repository](https://github.com/Sherler/CopilotKit) and create a fork.
...
Now that you've made your changes, commit and push them. Then, simply head over to the [Pull Requests page](https://github.com/Sherler/CopilotKit/pulls) and create a pull request. Well done!

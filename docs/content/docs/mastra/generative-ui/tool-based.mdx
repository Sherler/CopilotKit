...
<Callout>
  ...
  project](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-Mastra).
</Callout>
...
If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter-Mastra) as a starting point

...
<Callout>
    This video shows the [coagents starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) repo with various Copilot UI components applied to it!
</Callout>

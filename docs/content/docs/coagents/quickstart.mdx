    ...
    >
        ...
        >
            <Step>
                ...
                ```package-install
                npm install @turbo-agent/copilotkit-react-ui @turbo-agent/copilotkit-react-core
                ```
            </Step>
            <TailoredContent
                className="step"
                ...
                >
                    <Step>
                        ...
                        <Tabs groupId="language" items={["Python", "TypeScript"]}>
                            <Tab value="Python">
                                ```bash
                                git clone -n --depth=1 --filter=tree:0 https://github.com/Sherler/CopilotKit && cd CopilotKit && git sparse-checkout set --no-cone examples/coagents-starter/agent-py && git checkout && cd ..
                            ...
                            <Tab value="TypeScript">
                                ```bash
                                git clone -n --depth=1 --filter=tree:0 https://github.com/Sherler/CopilotKit && cd CopilotKit && git sparse-checkout set --no-cone examples/coagents-starter/agent-js && git checkout && cd ..
            ...
            >
                ...
                >
                    <Step>
                        ...
                        ```package-install
                        @turbo-agent/copilotkit-runtime class-validator
                        ```
                    </Step>
                    <Step>

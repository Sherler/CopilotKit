...
<Callout>
  This video shows the [coagents starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) repo with the [implementation](#implementation) section applied to it!
</Callout>

...
<Callout type="info">
  Pictured above is the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) with
...
```tsx title="ui/app/page.tsx"
import { useCoAgentStateRender } from "@turbo-agent/copilotkit-react-core"; // [!code highlight]

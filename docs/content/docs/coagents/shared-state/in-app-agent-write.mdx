...
<Steps>
  ...
  <Step>
    ...
    import { useCoAgent } from "@think-copilotkit/react-core"; // [!code highlight]
...
import { TextMessage, MessageRole } from "@think-copilotkit/runtime-client-gql";  // [!code highlight]

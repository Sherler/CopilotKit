...
<Callout>
  This video shows the [coagents starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) repo with the previous steps applied to it!
</Callout>
...
<Steps>
  <Step>
    ...
    If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) as a starting point
  ...
  <Step>
    ...
    import { useCoAgent } from "@turbo-agent/copilotkit-react-core"; // [!code highlight]
...
import { TextMessage, MessageRole } from "@turbo-agent/copilotkit-runtime-client-gql";  // [!code highlight]

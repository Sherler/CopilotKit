...
<Callout>
  This video demonstrates the [implementation](#implementation) section applied to out [coagents starter project](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter).
</Callout>
...
<Steps>
  <Step>
    ...
    This guide uses the [CoAgents starter repo](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter) as its starting point.

...
import { useCoAgent, useCoAgentStateRender } from "@turbo-agent/copilotkit-react-core"; // [!code --]
import { useCoAgent, useCoAgentStateRender, useCopilotAction } from "@turbo-agent/copilotkit-react-core"; // [!code ++]
// ...

...
<Callout type="info">
The illustration above is from the [CoAgent Starter](https://github.com/Sherler/CopilotKit/tree/main/examples/coagents-starter), included here for demonstration purposes.
</Callout>

...
<Callout>
  ...
  project](https://github.com/Sherler/CopilotKit/tree/main/examples/agno/starter).
</Callout>
...
If you don't already have an agent, you can use the [coagent starter](https://github.com/Sherler/CopilotKit/tree/main/examples/agno/starter) as a starting point

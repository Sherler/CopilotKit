 ...
 *
 * This component is part of the [@turbo-agent/copilotkit-react-textarea](https://npmjs.com/package/@turbo-agent/copilotkit-react-textarea) package.
 *
 * ```shell npm2yarn \"@turbo-agent/copilotkit-react-textarea"\
 * npm install @turbo-agent/copilotkit-react-core @turbo-agent/copilotkit-react-textarea
 * ```
 *
 * ### Usage
 *
 ...
 * ...
 * import "@turbo-agent/copilotkit-react-textarea/styles.css"; // [!code highlight]
 *
...
export interface CopilotTextareaProps
   ...
   * For full reference, [check the interface on GitHub](https://github.com/Sherler/CopilotKit/blob/main/CopilotKit/packages/react-textarea/src/types/base/base-copilot-textarea-props.tsx#L8).
   *
   ...
   *       For full reference, please [click here](https://github.com/Sherler/CopilotKit/blob/main/CopilotKit/packages/react-textarea/src/types/autosuggestions-config/suggestions-api-config.tsx#L4).
   *   </PropertyReference>
   *   <PropertyReference name="insertionApiConfig" type="InsertionApiConfig">
   *       For full reference, please [click here](https://github.com/Sherler/CopilotKit/blob/main/CopilotKit/packages/react-textarea/src/types/autosuggestions-config/insertions-api-config.tsx#L4).
   *   </PropertyReference>
   * </PropertyReference>
   *

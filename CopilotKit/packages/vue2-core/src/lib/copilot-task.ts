 ...
 *
 * ```tsx
 * import { CopilotTask, useCopilotContext } from "@turbo-agent/copilotkit-react-core";
 *
 ...
 * ```
 *
 * Have a look at the [Presentation Example App](https://github.com/Sherler/CopilotKit/blob/main/CopilotKit/examples/next-openai/src/app/presentation/page.tsx) for a more complete example.
 */

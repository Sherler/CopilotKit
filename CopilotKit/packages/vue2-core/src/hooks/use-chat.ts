// Vue2 version of useChat hook
// Converted from React to work with Vue2 components
import {
  FunctionCallHandler,
...
export interface UseChatOptions {
  ...
  messages: Message[];
  /**
   * The Vue2 method to update the chat messages.
   */
  ...
  /**
   * Vue2 method to update the isChatLoading value
   */

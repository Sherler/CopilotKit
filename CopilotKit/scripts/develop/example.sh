...
rm -rf .next
pnpm i
pnpm link --global @turbo-agent/copilotkit-react-ui @turbo-agent/copilotkit-react-core @turbo-agent/copilotkit-runtime-client-gql \
  @turbo-agent/copilotkit-shared @turbo-agent/copilotkit-runtime @copilotkit/sdk-js

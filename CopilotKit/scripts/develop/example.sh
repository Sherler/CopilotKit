...
rm -rf .next
pnpm i
pnpm link --global @copilotkit/react-ui @copilotkit/react-core @think-copilotkit/runtime-client-gql \
  @copilotkit/shared @think-copilotkit/runtime @copilotkit/sdk-js

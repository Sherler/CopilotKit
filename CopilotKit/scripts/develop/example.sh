...
rm -rf .next
pnpm i
pnpm link --global @think-copilotkit/react-ui @think-copilotkit/react-core @think-copilotkit/runtime-client-gql \
  @think-copilotkit/shared @think-copilotkit/runtime @copilotkit/sdk-js
